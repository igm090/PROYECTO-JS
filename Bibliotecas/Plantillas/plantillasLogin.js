    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="signup-form">
                ...
                <p class="text-center mt-3 text-secondary">Si ya tienes una cuenta, <a href="#">Inicia Sesión</a></p>
            </div>
        </div>
    </div>
</div>`;
...
<div class="row">
    <div class="col-md-4 offset-md-4">
        <div class="login-form bg-light mt-4 p-4">
            ...
            <hr class="mt-4">
            <div class="col-12">
                <p class="text-center mb-0">¿Aún no tienes cuenta? <a href="#">Regístrate</a></p>
            </div>
        </div>
    </div>
</div>
